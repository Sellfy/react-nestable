  ...
  _createClass(NestableItem, [{
    ...
    value: function render() {
      ...
      var itemProps = {
        ...
        }, _defineProperty(_cx, baseClassName + '--with-children', hasChildren), _defineProperty(_cx, baseClassName + '--children-open', hasChildren && !isCollapsed), _defineProperty(_cx, baseClassName + '--children-collapsed', hasChildren && isCollapsed), _defineProperty(_cx, baseClassName + '--placed-here', item.active), _cx))
      };
